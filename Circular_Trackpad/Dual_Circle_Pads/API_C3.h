...
*/
void API_C3_writeRegister(uint8_t i2c_channel, uint32_t address, uint8_t value);
 ...
 */
bool API_C3_setTimeBeforeIdle(uint8_t i2c_channel, uint16_t timeBeforeIdle_100ms); //given in 100 ms
...
bool API_C3_setTimeBeforeSleep(uint8_t i2c_channel, uint16_t timeBeforeSleep_100ms); //given in 100 ms
bool API_C3_setTimeInSleep(uint8_t i2c_channel, uint16_t sleepTime); //given in 100us increments
