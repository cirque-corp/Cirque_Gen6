...
#define PTP_MAX_CONTACTS        ((PROJECT_MAX_PACKET_SIZE - PTP_HEADER_BYTES - PTP_TRAILER_BYTES) / PTP_CONTACT_BYTES)
...
typedef struct
{
    ...
    uint8_t  decodedContactSlots;  //How many contact records were decoded from this packet
